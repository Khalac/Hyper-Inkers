  ...
  return (
    <div className="Section1_Nicole">
      ...
      <div className="Section1_Nicole_Text1">
        Meet Nicole, a 26-year-old professional piercer with a passion for body
        artistry. With 1.5 years of experience under her belt, she has attended
        conventions in both Asia and the United States. Nicole has honed her
        craft to an impressive level, catering to the needs of 20-30 clients
        daily and completing an astounding 40-60 piercings per day.
      </div>
