...
function WWYG() {
  ...
  const arrayOfShowing = [
    {
      ...
      image: Aw,
      title: "MANY AWARDS",
      description: "We aspire for the awards attained in those competitions to serve as acknowledged evidence of our commitment to quality."
    },
    {
      id: 2,
      image: Tech,
      title: "BEST TECHNIQUES",
      description: "As artists who are both youthful and seasoned, continually enhancing our understanding of techniques and embracing continuous learning."
    },
    {
      id: 3,
      image: Com,
      title: "TRULY COMPREHEND",
      description: "Above all, we consistently appreciate your ideas and desires, from comprehension to bringing your tattoo vision to life."
    },
  ]
  return (
    <div className="WWYG">
  ...
  <React.Fragment>
    ...
    :
        <div style={{display:"flex", flexDirection:'row', height: '50%', width:'70%', marginTop: '5%', justifyContent:'space-around'}}>
          {
