...
function WDWH() {
  ...
  return isMobile ? (
    <div className="WDWH">
      ...
      <h2 className="WDWH_Name">
        BRING YOU THE GREAT EXPERIENCE AND BEST SERVICE
      </h2>
      ...
      <div className="WDWH_Tag_Container">
        <div className="WDWH_Tag">
          ...
          <div className="WDWH_Tag_Text">
            ...
            <div className="WDWH_Tag_Text_Des" style={{ marginTop: "3%" }}>
    ...
    <div className="WDWH">
        ...
        <div className="WDWH_Tag_Container">
          <div className="WDWH_Tag">
            ...
            <div className="WDWH_Tag_Text">
              ...
              <div className="WDWH_Tag_Text_Des">
                Our artists embody professionalism, emphasizing punctuality,
                transparent pricing, and a positive, respectful client
                experience.
              </div>
            </div>
            <div
        ...
        <div className="WDWH_Tag_Container">
          <div className="WDWH_Tag">
            ...
            <div className="WDWH_Tag_Text">
              ...
              <div className="WDWH_Tag_Text_Des">
                Through consistent participation in global competitions, we
                fearlessly embrace challenges and carry the enduringenthusiasm
                of the tattoo profession.
              </div>
            </div>
            <div
              className="WDWH_Tag_Learn_More"
        ...
        <div className="WDWH_Tag_Container">
          <div className="WDWH_Tag">
            ...
            <div className="WDWH_Tag_Text">
              <div className="WDWH_Tag_Text_Name">30+ TROPHIES</div>
              <div className="WDWH_Tag_Text_Des">
                Accumulating awards boosts our profile, offering a solid
                assurance for customers. Enjoy your experience with us – more
                ink, more excitement.
              </div>
            </div>
            <div
      ...
      {/* <div style={{display:"flex", height:"30%", width:"90%", flexDirection:'row',marginTop: '5%'}}>
    <div className="WDWH_Tag_Container">
      <div className="WDWH_Tag">
        <img src={WDWH3} alt="" className="WDWH_Tag_Logo" />
        <div className="WDWH_Tag_Text">
